...
ActiveRecord::Schema.define(version: 20121215060442) do
  ...
  add_index "fan_locations", ["city", "state"], name: "index_fan_locations_on_city_and_state", using: :btree
  add_index "fan_locations", ["state", "country_code"], name: "index_fan_locations_on_state_and_country_code", using: :btree
